...
const About = () => {
  useEffect(() => {
    ...
    return (
      <div className="flex justify-center items-start p-10 h-screen md:flex-col">
        {/* Left div with image */}
        <div className="p-5 pl-[50px] md:w-[50%] md:h-[50%] sm:w-full sm:h-auto">
        <Image src={'/self.JPG'} width={250} height={250} className="" />
        </div>
  
        {/* Center div with text */}
        <div className="max-w-md self-start md:w-[100vh] h-[50vh] p-5">
...
//   return (
//     <div className="p-10 h-screen flex flex-col md:flex-row">
//       {/* Left div with image */}
//       <div className="pr-8 md:w-[50%] md:h-[50%] sm:w-full sm:h-auto">
//         <Image src={'/self.JPG'} width={250} height={250} />
//       </div>

//       {/* Center div with text */}
//       <div className="max-w-md self-start md:w-[50%] md:h-[50%] sm:w-full sm:mt-8">
//         <p className="leading-6 md:text-wrap sm:text-wrap">
//           Greetings! I'm Akrasi Daniel, a versatile professional adept in Frontend Development, Software Engineering, and Mechanical Engineering. With a blend of design flair and technical precision, I create visually captivating user interfaces and navigate complex code proficiently. My background in Mechanical Engineering adds a meticulous and detail-oriented approach, complemented by AWS Cloud expertise.
...
//       {/* Right div with information (hidden on smaller screens) */}
//       <div className="md:w-[50%] md:h-[50%] sm:w-full sm:hidden">
//         {/* Project Information */}
//         <div className="mb-4">
//           <p className="text-8xl font-bold">10+</p>
//           <h3 className="text-lg font-bold mb-2 text-slate-500">Projects<br/>
